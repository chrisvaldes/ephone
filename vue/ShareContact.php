                            ...
                            <div class="col m10 offset-m1 s12">
                                <div class="card" style="padding : 1rem 0; border-radius : 9px">
                                    <div class="card-body">
                                        ...
                                        <h1 class="card-title center" style="font-weight:bold; text-transform : uppercase">Partager <span style="font-size: 1.5rem; text-transform : capitalize"><?php echo $fetch_delete['nameContact']; ?> ?</span></h1>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <input type="hidden" name="contactNumber" value="<?php echo $fetch_delete['contactNumber']; ?>">
                                            <input type="hidden" name="nameContact" value="<?php echo $fetch_delete['nameContact']; ?>">
                                            <input type="email" name="userEmail" placeholder="Avec qui partager ? ex : x@gmail.com" />
                                        </div>
                                        <div class="card-action" style="display:flex; align-items : center; justify-content:space-around">
                                            <a href="ContactList.php">Annuler</a>
                                            <input type="submit" name="shareNumber" class="btn" value ='Partager'/>
                                        </div>
                                    </div>
                                </div>
                            </div>
